...
const LandingPage = () => {
	const schema = z.object({
		inputKey: z.string(),
		password: z.string().min(5, { message: "Password should be atleast 5 characters long" }),
	});
		...
		<div className="flex justify-center">
			<div className="px-10 md:px-20 py-6 max-w-[1440px]">
				<nav className="flex justify-between items-center">
					<img src="/assets/images/turningwayslogo.svg" alt="" className="w-36" />
				...
				<main className="lg:grid grid-cols-[1fr,1fr] xl:grid-cols-[500px,1fr]  mt-5  gap-x-10">
					<form
						...
						<p className="font-azo text=[#7F7E7E] lg:mb-4 text-center lg:text-start">
							TurningWays is an AI-powered digital tool designed to help churches efficiently
							organize their membership, manage giving, events and soul-winning all in one place.
						</p>
						...
						<div
							...
							<img src="/assets/images/twsymbol.svg" className="w-4 lg:w-fit" alt="" />

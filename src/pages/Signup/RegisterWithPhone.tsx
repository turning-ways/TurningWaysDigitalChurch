...
const RegisterWithPhone = () => {
	...
	const schema = z
		.object({
			first_name: z.string().min(4, { message: "Name should be atleast 4 characters long" }),
			last_name: z.string().min(4, { message: "Name should be atleast 4 characters long" }),
		...
		.refine((data) => data.password === data.passwordConfirm, {
			...
			path: ["passwordConfirm"], // This will show the error message on the passwordConfirm field
		});

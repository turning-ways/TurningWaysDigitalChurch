				...
				<form
					...
					<div className="space-y-8 mb-8">
						...
						{isParentChurch !== "Yes" && (
							<div className="relative">
								<HeaderTwo>
									Select church level within parent church <span className="text-secondary">*</span>
								</HeaderTwo>
								<div className="border border-[#EBEFF9] bg-[#F7FAFC] rounded-lg w-full px-3 py-1 flex items-center">
									<input
										className="outline-none w-full h-auto bg-inherit"
						...
						<div className="mb-2">
							<HeaderTwo>
								Enter your church's email address <span className="text-secondary">*</span>
							</HeaderTwo>
							<input
								type="text"
								className="border border-[#EBEFF9] bg-[#F7FAFC] rounded-xl w-full p-3 outline-none "
						...
						<div className="mb-2">
							<HeaderTwo>
								Enter your church's street address <span className="text-secondary">*</span>
							</HeaderTwo>
							<input
								type="text"
								className="border border-[#EBEFF9] bg-[#F7FAFC] rounded-xl w-full p-3 outline-none "

...
const QuickActions: React.FC<QuickActionsProps> = ({ display }) => {
	const items = [
		...
		{ name: "Send Bulk Message", icon: <CiMail />, action: handleSendBulkMessage },
		{ name: "Export Data", icon: <CiExport />, action: handleOnExport },
		{ name: "Import Data", icon: <CiImport />, action: handleOnImport },
	];
